      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        {images.map((src, i) => (
          <motion.button
            ...
            key={i}
            onClick={() => openAt(i)}
            className="group relative overflow-hidden rounded-xl ring-1 ring-white/5"
          >
        ...
        {open && (
          <motion.div className="fixed inset-0 z-50" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <div className="absolute inset-0 flex items-center justify-center p-6">
              ...
              >
                <div className="relative overflow-hidden rounded-[18px] ring-1 ring-[#5f7f6e]/40 shadow-2xl">
                ...
                <div className="mt-4 flex justify-between text-stone-300 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="h-2 w-2 rounded-full bg-[#5f7f6e]" />
